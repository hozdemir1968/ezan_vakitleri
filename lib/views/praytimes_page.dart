...
class _PraytimesPageState extends State<PraytimesPage> {
  ...
  Widget hasDataWidget(List<PraytimesVM> praytimes) {
    ...
    double spaceHeight = size.height / 40;
        ...
        SliverList(
          delegate: SliverChildBuilderDelegate(childCount: praytimes.length, (
            ...
            return Column(
              ...
              children: [
                Text(
                  DateFormat.yMMMMEEEEd(lngCode).format(praytimes[index].gregorianDate!),
                  style: textStyle20B(),
                ),
                Text(praytimes[index].hijriDate.toString(), style: textStyle18()),
                SizedBox(height: spaceHeight * 0.3),
                Row(
